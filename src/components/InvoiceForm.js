      ...
      <Row>
        <Col md={8} lg={9}>
          <Card className="p-4 p-xl-5 my-3 my-xl-4">
            ...
            <Row className="mb-5">
              <Col>
                <Form.Label className="fw-bold">Inovice To:</Form.Label>
                <Form.Control placeholder={"Receiver Name"} rows={3} value={this.state.billTo} type="text" name="billTo" className="my-2" onChange={(event) => this.editField(event)} autoComplete="name" required="required"/>
              ...
              <Col>
                <Form.Label className="fw-bold">Invoice From:</Form.Label>
                <Form.Control placeholder={"Sender Name"} rows={3} value={this.state.billFrom} type="text" name="billFrom" className="my-2" onChange={(event) => this.editField(event)} autoComplete="name" required="required"/>
            ...
            <Form.Control placeholder="Thank you for visiting us!" name="notes" value={this.state.notes} onChange={(event) => this.editField(event)} as="textarea" className="my-2" rows={1} />
          </Card>
        </Col>
        <Col md={4} lg={3}>
          <div className="sticky-top pt-md-3 pt-xl-4">
            ...
            <Button  variant="primary" type="submit" className="btn-53 d-block w-100">Review Invoice</Button>
          </div>
        </Col>
      </Row>
    </Form>)
